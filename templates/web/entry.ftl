...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .pokeball {
                background: -webkit-radial-gradient(circle at top left, rgba(255, 255, 255, 0.3), rgba(0, 0, 0, 0)), -webkit-radial-gradient(circle at bottom right, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0)),
                    -webkit-linear-gradient(#eb615e 50%, #fff 49%);
                background: radial-gradient(circle at top left, rgba(255, 255, 255, 0.3), rgba(0, 0, 0, 0)), radial-gradient(circle at bottom right, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0)), linear-gradient(#eb615e 50%, #fff 49%);
        ...
        <style>
            ...
            *,
            ...
            .pokeball {
                background: radial-gradient(circle at top left, #ffffff4d, #0000), radial-gradient(circle at bottom right, #0000001a, #0000), linear-gradient(#eb615e 50%, #fff 0);
                background: linear-gradient(#eb615e 50%, #fff 0);
                border-radius: 50%;
                height: 12rem;
                left: 50%;
                margin: -6rem 0 0 -6rem;
